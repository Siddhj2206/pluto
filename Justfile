...
export bib_image := env("BIB_IMAGE", "ghcr.io/osbuild/bootc-image-builder:latest@sha256:1a06bc6ab9206793c0da3fc1fd6e2b8a1d04bec52dee1a533fc718cdb25bca21")
...
# HEAD SHA.
#
# Example: just build pluto stable-testing
